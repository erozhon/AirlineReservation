...
@WebServlet(name = "ReservationCancelServlet", urlPatterns = "/cancel_reservation")
public class ReservationCancelServlet extends HttpServlet {
    private DaoManager dm;
    private Dao<Reservation> reservationDao;

    public ReservationCancelServlet() throws Exception {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Boolean cancelled = Boolean.parseBoolean("true");
        ...
        request.getRequestDispatcher("reservation_cancel.jsp").forward(request, response);
    }
